...
public class Utilities {
    ...
    private static boolean validateFieldOnMainThread(Handler mainHandler, TextInputEditText field,
                                                     String errorMessage) {
    ...
    public static CompletableFuture<Boolean> validate(Context context,
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,firstNameField,
                    "First Name is required"));
            isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,lastNameField,
                    "Last Name is required"));
            isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,emailField,
                    "Email is required"));
            if (employee == null) {
                isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,passwordField,
                        "Password is required"));
            }

            if (joiningDateField != null) {
                isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,joiningDateField,
            ...
            if (allowedLeavesField != null) {
                isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,allowedLeavesField,
                        "Allowed Leaves is required"));
            }

            if (passwordRepeatField != null) {
                isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,passwordRepeatField,
            ...
            isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,departmentField,
                    "Department is required"));
            if (salaryField != null) {
                isValid.set(isValid.get() & Utilities.validateFieldOnMainThread(mainHandler,salaryField,
                        "Salary is required"));
            }
